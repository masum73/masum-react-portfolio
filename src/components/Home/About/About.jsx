...
const About = () => {
    return (
        <div id='about' className='mx-auto w-9/12 pt-12'>
            ...
            {/* <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Facilis perferendis laudantium incidunt perspiciatis maiores explicabo consequuntur quod iure a enim.
            </p> */}
        </div>
    );
};
