      ...
      <Button
        onClick={() =>
          (window.location.href =
            "https://drive.google.com/uc?id=1U3BwAt-68yHZjCZ-A_MHys7GGwhvI5TR&export=download")
        }
        color="indigo"
        ...
        <VerticalTimeline>
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">
              ReliSource Technologies LTD, Gulshan, Dhaka
            </h4>
            <p>Working on a Financial Project in Web</p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">
              Beyond Innovations & Technologies Limited, Banani, Dhaka
            </h4>
            <p>Worked on HealthCare, Social Projects in Android and IOS Apps</p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">
              The City Bank Ltd, Gulshan, Dhaka
            </h4>
            <p>Worked on core banking software project</p>
          </VerticalTimelineElement>
          ...
          <VerticalTimelineElement
            ...
            icon={<IoSchoolSharp />}
          >
            <h3 className="vertical-timeline-element-title">Postgraduate</h3>
            <h3 className="vertical-timeline-element-title">
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">
              Credential ID 21-CTFL-191151-12
            </h4>
          </VerticalTimelineElement>
        </VerticalTimeline>
      </div>
